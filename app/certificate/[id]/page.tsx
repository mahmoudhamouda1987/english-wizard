  ...
  return (
    <main id="main-content" style={{ maxWidth: 780, margin: "0 auto", padding: "48px 24px" }}>
      <section className="panel" style={{ textAlign: "center", padding: "48px 32px", border: "3px solid #6840d6", borderRadius: 24 }}>
        ...
        <div style={{ fontSize: 56, fontWeight: 800, color: "var(--accent-text)", letterSpacing: "-.02em", margin: "8px 0" }}>{cert.level}</div>
        <p style={{ color: "var(--text-secondary)", maxWidth: 480, margin: "0 auto 18px" }}>{LEVEL_DESCRIPTION[cert.level] ?? ""}</p>
        ...
        <div style={{ display: "inline-block", marginTop: 10, padding: "8px 14px", background: "#f4f2fb", borderRadius: 10, fontSize: 11, fontFamily: "monospace", color: "var(--accent-text)" }}>
