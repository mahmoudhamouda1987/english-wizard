  ...
  <section aria-label="Interactive lesson materials" style={{marginTop:18,padding:"16px 20px",background:"var(--surface)",borderRadius:14,border:"1px solid var(--border)"}}>
   ...
   {tab==="mission"&&mission&&(
    <div style={{display:"grid",gap:14}}>
     <p style={{margin:0}}><span className="chip" style={{fontWeight:800,background:"var(--accent-primary)",color:"var(--accent-contrast)"}}>Stage · {mission.stageName}</span> <em>{mission.stageClaim}</em></p>
     ...
     <div className="tint-accent" style={{padding:14,borderRadius:12}}>
      <p className="tint-title" style={{margin:"0 0 6px",fontWeight:800}}> AI role-play — {mission.roleplay.scenarioId.replace("rp-","")}</p>
     ...
     <div className="tint-info" style={{padding:14,borderRadius:12}}>
      <p className="tint-title" style={{margin:"0 0 6px",fontWeight:800}}> Writing challenge ({mission.writing.genre})</p>
      <p style={{margin:0,lineHeight:1.7}}>{mission.writing.prompt} <em>({mission.writing.minWords}–{mission.writing.maxWords} words)</em></p>
     </div>
     <div className="tint-warning" style={{padding:14,borderRadius:12}}>
      <p className="tint-title" style={{margin:"0 0 6px",fontWeight:800}}>🎤 Speaking challenge</p>
     ...
     <div className="tint-success" style={{padding:14,borderRadius:12,borderLeft:"4px solid var(--success)"}}>
      <p className="tint-title" style={{margin:"0 0 6px",fontWeight:800}}> Real-life mission</p>
